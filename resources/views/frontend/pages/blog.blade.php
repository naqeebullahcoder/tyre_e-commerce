...
@section('title','TYRE SHOP || Blog Page')
...
@section('main-content')
   ...
   <main class="main">
       <div class="container">
           <div class="content">
               <h1 class="my-4 my-md-5 text-uppercase">Blog</h1>
                   ...
                   <article class="post-item">
                       ...
                       <div class="post-content">
                           ...
                           <header class="post-header">
                               <a href="{{route('blog.detail',$post->slug)}}" class="h2">{{$post->title}}</a>
                           </header>
                           <div class="post-info">
                               <time class="post-time mr-2"><i class="far fa-clock"></i> {{$post->created_at->format('d M, Y. D')}}</time>
                               <span class="post-author"><i class="fas fa-pencil-alt"></i>   @foreach($author_info as $data)
                                       @if($data->name)
                                           {{$data->name}}
                                       @else
                                           Anonymous
                        ...
                        {{--<div class="single-widget newsletter">--}}
                            ...
                            {{--<div class="letter-inner">--}}
                                ...
                                {{--<form method="POST" action="{{route('subscribe')}}" class="form-inner">--}}
                                    {{--@csrf--}}
                                    {{--<input type="emails" name="emails" placeholder="Enter your emails">--}}
