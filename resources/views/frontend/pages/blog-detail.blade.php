        ...
        <div class="content">
            <div class="post-grid">
                <article class="post-item">
                    ...
                    <div class="post-thumb">
                        <img src="{{asset('public/frontend/assets/images/blog-img1.jpg')}}" alt="">
                    </div>
                    <div class="post-content-single">
                        <header class="post-header mt-0">
                            <h1 class="text-white h2">{{$post->title}}</h1>
                        </header>
                        <div class="post-info">
                            <time class="post-time mr-2"><i class="far fa-clock"></i> {{$post->created_at->format('M d, Y')}} </time>
                            <span class="post-author"><i class="fas fa-pencil-alt"></i> By {{$post->author_info['name']}} </span>
                            <span class="post-author"><i class="fa fa-comments"></i> Comment ({{$post->allComments->count()}})</span>
                        </div>
                        <div class="content">
                            @if($post->quote)
                        ...
                        <div class="content">
                            ...
                            @endphp
                            @foreach($tags as $tag)
                                <p style="margin-left: 20px"><a href="javascript:void(0);">{{$tag}}</a></p>
                            @endforeach
                        </div>
                    </div>
                </article>
            ...
            <div>
                {{--<div class="media mb-4">--}}
                    {{--<img src="assets/images/user-img.jpg" class="mr-3" alt="User Img">--}}
                ...
                <form class="form comment_form" id="commentForm" action="{{route('post-comment.store',$post->slug)}}" method="POST">
                    ...
                    <button type="submit" class="btn btn-outline-dark"><span class="comment_btn comment">Post Comment</span><span class="comment_btn reply" style="display: none;">Reply Comment</span></button>
                </form>
                @endauth
            </div>
            <div class="col-12"><br>
                <div class="comments">
                    <h5 class="comment-title">Comments ({{$post->allComments->count()}})</h5>
                    <!-- Single Comment -->
