...
@section('title','TYRE SHOP || PRODUCT')
						...
						<div class="col-lg-3 col-md-4 col-12">
							<div class="shop-sidebar">
                                ...
                                {{--<div class="single-widget category">--}}
                                    ...
                                    {{--<ul class="categor-list">--}}
                                        {{--@php--}}
                                            {{--$brands=DB::table('brand')->orderBy('title','ASC')->where('status','active')->get();--}}
                                        {{--@endphp--}}
                                        {{--@foreach($brands as $brand)--}}
                                            {{--<li><a href="{{route('brand',$brand->slug)}}">{{$brand->title}}</a></li>--}}
                                        {{--@endforeach--}}
                                    {{--</ul>--}}
                                {{--</div>--}}
                                <!--/ End Single Widget -->
										...
										<div class="shop-shorter">
											...
											<div class="single-shorter">
												...
												<select class='sortBy' name='sortBy' onchange="this.form.submit();">
													...
													<option value="brand" @if(!empty($_GET['sortBy']) && $_GET['sortBy']=='tyersbrand') selected @endif>Brand</option>
												</select>
											</div>
										</div>
										<ul class="view-mode">
